...
pub fn (sup NdrSupplement) comments() []NdrComment {
	...
	match sup.supplement {
		NdrString, NdrStructureString, NdrConformantString, NdrConformantStructureString {
			comments << NdrComment{
				value: 'range: ${sup.part_one},${sup.part_two}'
			}
		}
		NdrHandle, NdrSystemHandle {
			comments << NdrComment{
				value: 'flags: ${sup.part_one.hex()} contextID: ${sup.part_two.hex()}'
			}
		}
		else {}
	}
